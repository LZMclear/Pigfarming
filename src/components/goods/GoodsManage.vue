<template>
  <div>
    <div style="margin-bottom: 5px;">
      <el-input v-model="name" placeholder="请输入生猪名" suffix-icon="el-icon-search" style="width: 200px;"
                @keyup.enter.native="loadPost"></el-input>
      <el-select v-model="storage" placeholder="请选择养殖场" style="margin-left: 5px;">
        <el-option
    ...
    <el-table :data="tableData"
      ...
      <el-table-column prop="name" label="生猪名" width="180">
      </el-table-column>
      <el-table-column prop="storage" label="养殖场" width="180" :formatter="formatStorage">
      </el-table-column>
