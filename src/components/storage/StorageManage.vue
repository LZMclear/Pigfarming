<template>
  <div>
    ...
    <div style="margin-bottom: 5px;margin-top: 2px;">
      <el-input v-model="name" placeholder="请输入养殖场名称" suffix-icon="el-icon-search" style="width: 200px;"
    ...
    <el-table :data="tableData"
      ...
      <el-table-column prop="name" label="养殖场名称" width="180">
      </el-table-column>
      <el-table-column prop="remark" label="养殖人员名单">
      </el-table-column>
      <el-table-column prop="temperature" label="温度 / ℃">
      </el-table-column>
      <el-table-column prop="humidity" label="湿度 / 百分比">
      </el-table-column>
      <el-table-column prop="density" label="密度 / 平方米">
      </el-table-column>
    ...
    <el-dialog
      ...
      <el-form ref="form" :rules="rules" :model="form" label-width="80px">
        ...
        <el-form-item label="养殖场人员" prop="remark">
          <el-col :span="20">
...
<script>
import FarmTable from '../table/FarmTable.vue';
export default {
  name: "StorageManage",
  components:{FarmTable},
  data() {
    return {
      tableData: [],
      pageSize: 5,
