<template>
  <div>
    ...
    <el-table :data="tableData"
      ...
      <el-table-column prop="goodsname" label="生猪名" width="180">
      </el-table-column>
      <el-table-column prop="storagename" label="养殖场名称" width="180">
      </el-table-column>
      ...
      <el-table-column prop="count" label="买卖数量" width="180">
      </el-table-column>
      <el-table-column prop="createtime" label="操作时间" width="180">
      </el-table-column>
      <el-table-column prop="remark" label="收入或支出">
      </el-table-column>
    </el-table>
    <el-pagination
